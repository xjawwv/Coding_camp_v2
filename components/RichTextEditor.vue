...
const editor = useEditor({ extensions: [StarterKit, Image, Placeholder.configure({ placeholder: 'Tulis materi course di sini...' })], content: parseContent(props.modelValue), onUpdate: ({ editor: instance }) => emit('update:modelValue', instance.getJSON() as Record<string, unknown>) })
